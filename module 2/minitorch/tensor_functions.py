    ...
    class Backend:
        ...
        class Mul(Function):
            ...
            def backward(ctx, grad_output):
                ...
                return loadvar2 * grad_output, loadvar1 * grad_output
        ...
        class Sigmoid(Function):
            ...
            def backward(ctx, grad_output):
                ...
                return loadvar * (1 - loadvar) * grad_output
        ...
        class ReLU(Function):
            ...
            def backward(ctx, grad_output):
                loadvar = ctx.saved_values
                return relu_back_zip(loadvar, grad_output)
        ...
        class Log(Function):
            ...
            def backward(ctx, grad_output):
                loadvar = ctx.saved_values
                return log_back_zip(loadvar, grad_output)
        ...
        class Exp(Function):
            ...
            def backward(ctx, grad_output):
                loadvar = ctx.saved_values
                return exp_map(loadvar) * grad_output
        ...
        class Mean(Function):
            ...
            def forward(ctx, a, dim):
                if dim is not None:
                    ...
                    return add_reduce(a, list(range(a.dims))) / a.size

            @staticmethod
            def backward(ctx, grad_output):
                loadvar = ctx.saved_values
                return grad_output / loadvar
